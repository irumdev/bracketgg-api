...
class ImageRequest extends CommonFormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        $boardCategory = $this->route('channelBoardCategory');
        switch ($boardCategory->write_permission) {

            case ChannelArticleWritePermissions::ONLY_OWNER:
                return $this->requestUser->can('updateChannel', [
                    $this->route('slug')
                ]);

            case ChannelArticleWritePermissions::ALL_USER:
                return true;
        }
    }
    ...
    {
        return UploadBoardArticleImage::rules();
    }

    public function messages(): array
    {
        return UploadBoardArticleImage::messages();
    }
